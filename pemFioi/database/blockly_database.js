    ...
    var language_strings = {
        en: {
            ...
            label: {
                ...
                displayTablesOnGraph: 'displayTablesOnGraph(%1, %2, %3)'
            },
            code: {
                loadTable: 'loadTable',
        ...
        fr: {
            ...
            label: {
                ...
                displayTablesOnGraph: 'visualiser les tables sur un graphe(%1, %2, %3)'
            },
            code: {
                loadTable: 'loadTable',
                loadTableFromCsv: 'loadTableFromCsv',
...
*/
    ...
    context.database = {
        ...
        displayTablesOnGraph: function(table, nameColumn1, nameColumn2, callback) {
        ...
        database: {
            database: [
                ...
                { name: 'displayTablesOnGraph',
                    params: ['Block', 'String', 'String'],
                    params_names: ['table', 'nameColumn1', 'nameColumn2'],
                },
            ],
            texts: [
                { name: 'printConsole',
