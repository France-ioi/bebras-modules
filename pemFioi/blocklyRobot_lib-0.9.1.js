var getContext = function(display, infos, curLevel) {
   var localLanguageStrings = {
      fr: {
         ...
         messages: {
            marblePlacedCorrectly: "Bravo, vous avez rangé la bille&nbsp;!",
            marblePlacedIncorrectly: "La bille est mal rangée !",
            marblesPlacedCorrectly: "Bravo, vous avez rangé toutes les billes&nbsp;!",
            marblesPlacedIncorrectly: "Les billes sont mal rangées !",
            reachedGreenZone: "Bravo, le robot a atteint la zone verte !",
      ...
      de: {
         label: {
            ...
            writeNumber: "Setze die Nummer des Feldes auf",
