   ...
   var localLanguageStrings = {
      ...
      nl: {
         ...
         description: {
            ...
            gridEdgeBelow: "randGridOnder() : is de rand van het rooster direct onder de robot?",
            platformInFront: "platformVoor() : is er een platform recht voor de robot?",
            numberUnder: "nummerVakje() : nummer geschreven op het vakje van de robot",
...
//      context.blocklyHelper.updateSize();
   ...
   context.customBlocks = {
      robot: {
         ...
         sensors: [
            { name: "onTransportable",    yieldsValue: 'bool' },
            { name: "onRoundObject",      yieldsValue: 'bool' },
            { name: "onSquareObject",     yieldsValue: 'bool' },
            { name: "onTriangleObject",   yieldsValue: 'bool' },
            { name: "onDottedObject",     yieldsValue: 'bool' },
            { name: "onStripedObject",    yieldsValue: 'bool' },
            { name: "onFullObject",       yieldsValue: 'bool' },
            { name: "onHole",             yieldsValue: 'bool' },
            { name: "transportableShape", yieldsValue: 'string' },
            { name: "transportableColor", yieldsValue: 'string' },
            { name: "transportableRed",   yieldsValue: 'bool' },
            { name: "transportableBlue",  yieldsValue: 'bool' },
            { name: "transportableSquare", yieldsValue: 'bool' },

            { name: "greenCell",          yieldsValue: 'bool' },
            { name: "brownCell",          yieldsValue: 'bool' },
            { name: "markedCell",         yieldsValue: 'bool' },

            { name: "obstacleInFront",    yieldsValue: 'bool' },
            { name: "obstacleRight",      yieldsValue: 'bool' },
            { name: "obstacleLeft",       yieldsValue: 'bool' },
            { name: "obstacleEast",       yieldsValue: 'bool' },
            { name: "obstacleWest",       yieldsValue: 'bool' },
            { name: "obstacleNorth",      yieldsValue: 'bool' },
            { name: "obstacleSouth",      yieldsValue: 'bool' },

            { name: "paintInFront",       yieldsValue: 'bool' },
            { name: "paintOnCell",        yieldsValue: 'bool' },
            { name: "paintNorth",         yieldsValue: 'bool' },
            { name: "paintNorthWest",     yieldsValue: 'bool' },
            { name: "paintNorthEast",     yieldsValue: 'bool' },
            { name: "colorUnder",         yieldsValue: 'string' },
            { name: "numberUnder",        yieldsValue: 'int' },
            { name: "gridEdgeInFront",    yieldsValue: 'bool' },
            { name: "gridEdgeEast",       yieldsValue: 'bool' },
            { name: "gridEdgeWest",       yieldsValue: 'bool' },
            { name: "gridEdgeAbove",      yieldsValue: 'bool' },
            { name: "gridEdgeBelow",      yieldsValue: 'bool' },
            { name: "platformInFront",    yieldsValue: 'bool' },
            { name: "platformInFrontAndBelow", yieldsValue: 'bool' },
            { name: "platformAbove",      yieldsValue: 'bool' },
            { name: "dir",                yieldsValue: 'string' },
            { name: "col",                yieldsValue: 'int' },
            { name: "row",                yieldsValue: 'int' },
            { name: "onPill",             yieldsValue: 'bool' }
         ]
      },
      transport: {
         sensors: [
            { name: "number", yieldsValue: 'int',                     handler: context.transportable_number },
            { name: "exists", yieldsValue: 'bool',   params: [null],   handler: context.transportable_exists },
            { name: "trans_row",    yieldsValue: 'int',   params: [null],   handler: context.transportable_row },
            { name: "trans_col",    yieldsValue: 'int',   params: [null],   handler: context.transportable_col }
         ]
      },
      debug: {
         debug: [
