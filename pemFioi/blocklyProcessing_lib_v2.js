   ...
   var localLanguageStrings = {
      ...
      nl: {
         ...
         messages: {
            ...
            mistakeExtraPixel: "Er zijn te veel pixels gekleurd.",
            mistakeMissedPixel: "Er ontbreken pixels."
         },
         misc: {
            colon: ": "
         }
      ...
      de: {
         ...
         messages: {
            ...
            mistakeExtraPixel: "Es wurden zu viele Pixel gefärbt.",
            mistakeMissedPixel: "Es fehlen Pixel."
         },
         misc: {
            colon: ": "
         }
