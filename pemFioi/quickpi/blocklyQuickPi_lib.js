...
var quickPiLocalLanguageStrings = {
    ...
    it: { // Italian strings // TODO
        ...
        messages: {
            ...
            wrongState: "Test fallito : {0} è rimasto nello stato {1} invece di {2} a t={3}ms.",
            wrongStateDrawing: "Test fallito : {0} differisce di {1} pixel rispetto alla visualizzazione prevista a t={2}ms.",
            wrongStateSensor: "Test fallito : il tuo programma non ha letto lo stato di {0} dopo t={1}ms.",
