...
var quickAlgoLanguageStrings = {
   fr: {
      ...
      limitedUses: 'Vous utilisez trop souvent un mot-clé à utilisation limitée : "{name}".',
      limitedAssign: 'Vous n\'avez pas le droit de réassigner un mot-clé à utilisation limitée : "{name}".',
      forbiddenKeyword: 'Le mot-clé {name} est interdit ici !',
      emptyProgram: "Vous ne pouvez pas valider un programme vide !",
   ...
   en: {
      ...
      limitedUses: 'You use too many of a limited-use keyword: "{name}".',
      limitedAssign: 'You are not allowed to reassign a limited-use keyword: "{name}".',
      forbiddenKeyword: 'The keyword {name} is forbidden here!',
      emptyProgram: "You cannot submit an empty program!",
   ...
   de: {
      ...
      limitedUses: 'Du verwendest zu oft ein Schlüsselwort mit beschränkter Nutzung: "{name}".',
      limitedAssign: 'Du darfst ein Schlüsselwort mit beschränkter Nutzung nicht neu zuweisen: "{name}".',
      forbiddenKeyword: 'Das Schlüsselwort {name} ist hier verboten!',
      emptyProgram: "Du kannst kein leeres Programm absenden!",
   ...
   es: {
      ...
      limitedUses: 'Utilizas demasiado a menudo una palabra clave de uso limitado: "{name}".',
      limitedAssign: 'No tienes permiso para reasignar una palabra clave de uso limitado: "{name}".',
      forbiddenKeyword: '¡La palabra clave {name} está prohibida aquí!',
      emptyProgram: "¡No puedes validar un programa vacío!",
   ...
   sl: {
      ...
      limitedUses: 'Prevečkrat uporabljaš ključno besedo z omejeno uporabo: "{name}".',
      limitedAssign: 'Ključne besede z omejeno uporabo ne smeš ponovno prirediti: "{name}".',
      forbiddenKeyword: 'Ključna beseda {name} tukaj ni dovoljena!',
      emptyProgram: "Praznega programa ne moreš oddati!",
   ...
   it: {
      ...
      limitedUses: 'Usi troppo spesso una parola chiave a uso limitato: "{name}".',
      limitedAssign: 'Non puoi riassegnare una parola chiave a uso limitato: "{name}".',
      forbiddenKeyword: 'La parola chiave {name} è vietata qui!',
      emptyProgram: "Non puoi validare un programma vuoto!",
   ...
   nl: {
      ...
      limitedUses: 'U gebruikt te vaak een trefwoord met beperkt gebruik: "{name}".',
      limitedAssign: 'U mag een trefwoord met beperkt gebruik niet opnieuw toekennen: "{name}".',
      forbiddenKeyword: 'Het trefwoord {name} is hier verboden!',
      emptyProgram: 'U kunt geen leeg programma indienen!',
