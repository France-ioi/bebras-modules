   ...
   var localLanguageStrings = {
      fr: {
         ...
         label: {
            ...
            strokeWeight: "définir l'épaisseur des lignes à",
            ...
            setVisible: "définir la visibilité à",
            ...
            rotate: "pivoter de",
            rotateX: "pivoter sur l'axe X de",
            rotateY: "pivoter sur l'axe Y de",
            rotateZ: "pivoter sur l'axe Z de",
            scale: "appliquer une échelle de",
            ...
            stroke: "définir la couleur de ligne à",
            alpha: "opacité dans",
            ...
            // image
            createImage: "nouvelle image de taille %1 %2",
            ...
            loadFont: "nouvelle police de nom",
            ...
            textLeading: "définir l'interligne du texte à",
            textMode: "utiliser le mode %1 pour le texte",
            textSize: "définir la taille du texte à",
            textWidth: "largeur du texte",
            textAscent: "hauteur du texte %1 au-dessus de la ligne de base",
            textDescent: "hauteur du texte %1 en dessous de la ligne de base"
         },
         code: {
            // environment
