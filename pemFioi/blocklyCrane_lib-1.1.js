...
var getContext = function(display, infos, curLevel) {
   ...
   context.conceptList = [
      ...
      {id: 'wordgame_presentation', name: 'Mots casés', url: conceptBaseUrl+'#wordgame_presentation'},
      {id: 'wordle_presentation', name: 'Wordle', url: conceptBaseUrl+'#wordle_presentation'},
      ...
      {id: 'blockly_controls_repeat', name: 'Boucle for', python: ['blockly_controls_repeat'], categoryId: 'languageConcepts', keepConceptName: true},
      {id: 'blockly_controls_if', name: 'Instructions conditionnelles', python: ['blockly_controls_if'], categoryId: 'languageConcepts', keepConceptName: true},
      {id: 'blockly_logic_compare', name: 'Opérateurs de comparaison', python: ['blockly_logic_compare'], categoryId: 'languageConcepts', keepConceptName: true},
      {id: 'blockly_controls_whileUntil', name: 'Boucle while', python: ['blockly_controls_whileUntil'], categoryId: 'languageConcepts', keepConceptName: true},
      {id: 'blockly_logic_operation', name: 'Opérateurs logiques', python: ['blockly_logic_operation'], categoryId: 'languageConcepts', keepConceptName: true},
      {id: 'variables', name: 'Variables', python: ['variables'], categoryId: 'languageConcepts', keepConceptName: true},
      {id: 'extra_function', name: 'Fonctions sans paramètre', python: ['extra_function'], categoryId: 'languageConcepts', keepConceptName: true},
      {id: 'extra_function_parameters', name: 'Fonctions avec paramètre', python: ['extra_function_parameters'], categoryId: 'languageConcepts', keepConceptName: true},
      {id: 'blockly_text', name: 'Chaînes de caractères', python: ['blockly_text'], categoryId: 'languageConcepts', keepConceptName: true},
      {id: 'extra_list', name: 'Listes', python: ['extra_list'], categoryId: 'languageConcepts', keepConceptName: true},
