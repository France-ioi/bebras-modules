...
class PythonStackViewContainer extends React.Component {
  constructor(props) {
    ...
    _defineProperty(this, "getWindowWidth", () => {
      return Math.max(document.body.scrollWidth, document.documentElement.scrollWidth, document.body.offsetWidth, document.documentElement.offsetWidth, document.documentElement.clientWidth);
    });

    _defineProperty(this, "getWindowHeight", () => {
    ...
    _defineProperty(this, "mouseMoveHandler", (mouseX, mouseY) => {
    ...
    _defineProperty(this, "toggleCollapsedHandler", () => {
    ...
    if (this.getWindowWidth() < DESKTOP_MIN_WIDTH) {
      initTop = this.getWindowHeight() - MAX_CONTENT_HEIGHT - MOBILE_BOTTOM_MENU_HEIGHT, initRight = MOBILE_RIGHT_MARGIN;
    }
