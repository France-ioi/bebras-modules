  ...
  customContextMenu: function(options) {
    ...
    if (!this.isCollapsed()) {
      for (var i = 0; i < this.arguments_.length; i++) {
        ...
        var xmlBlock = goog.dom.createDom('xmlBlock');
        xmlBlock.setAttribute('type', 'data_variable');
        xmlBlock.setAttribute('gap', 8);
        xmlBlock.appendChild(Blockly.Variables.createVariableDom_(name));
